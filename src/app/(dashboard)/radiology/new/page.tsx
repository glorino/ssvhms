...
const modalityOptions = ["X-Ray", "MRI", "CT Scan", "Ultrasound"]
  ...
  return (
    <div style={{ padding: "24px", minHeight: "100vh", background: "#f8fafc" }}>
      <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "24px" }}>
        ...
        <div>
          <h1 style={{ fontSize: "24px", fontWeight: 700, color: "#0f172a", margin: 0 }}>New Radiology Order</h1>
          <p style={{ fontSize: "14px", color: "#64748b", margin: "4px 0 0" }}>Order a new radiology examination</p>
        </div>
      </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "24px", alignItems: "start" }}>
          <div style={cardStyle}>
            <h2 style={{ fontSize: "16px", fontWeight: 600, color: "#0f172a", margin: "0 0 20px", padding: "0 0 12px", borderBottom: "2px solid #f0fdfa", display: "flex", alignItems: "center", gap: "8px" }}>
              <Scan size={18} style={{ color: accent }} />
              Examination Details
            </h2>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
              ...
              <div>
                ...
                <select name="modality" value={formData.modality} onChange={handleChange} required style={{ ...inputStyle, appearance: "none" as const, cursor: "pointer" }}>
              ...
              <div>
                ...
                <input type="text" name="bodyPart" value={formData.bodyPart} onChange={handleChange} placeholder="e.g., Chest, Abdomen, Knee" required style={inputStyle} />
              </div>
            </div>
            <div style={{ marginTop: "16px" }}>
              <label style={labelStyle}>Clinical Indication *</label>
              <textarea name="clinicalIndication" value={formData.clinicalIndication} onChange={handleChange} placeholder="Describe the clinical reason for this examination..." rows={3} required style={{ ...inputStyle, resize: "vertical" as const, minHeight: "80px" }} />
            </div>
            <div style={{ marginTop: "16px" }}>
              <label style={labelStyle}>Additional Notes</label>
              <textarea name="notes" value={formData.notes} onChange={handleChange} placeholder="Any additional instructions or notes..." rows={2} style={{ ...inputStyle, resize: "vertical" as const }} />
            </div>
          </div>
          ...
          <div style={cardStyle}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: "13px" }}>
                ...
                <span style={{ fontWeight: 600, color: "#0f172a" }}>{formData.modality || "-"}</span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: "13px" }}>
                <span style={{ color: "#64748b" }}>Body Part</span>
                <span style={{ fontWeight: 600, color: "#0f172a" }}>{formData.bodyPart || "-"}</span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: "13px" }}>
